...
public class Bladerollen extends Hazard implements Armored, Bladed, Groundable, Roving, Destructible {
    ...
    // ctor
    public Bladerollen(Vector2 position, Enums.Material type, float vulnerabilities) {
        this.type = type;
