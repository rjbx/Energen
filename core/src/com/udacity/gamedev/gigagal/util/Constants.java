...
public final class Constants {
    ...
    public static final float HOVER_TURBO_INCREMENT = 1f;
    ...
    public static final String STAND_SHOOT_RIGHT = "avatar-stand-shoot-right";
    public static final String STAND_BLAST_RIGHT_1 = "avatar-stand-blast-right-1";
    public static final String STAND_BLAST_RIGHT_2 = "avatar-stand-blast-right-2";
    public static final String STAND_BLAST_RIGHT_3 = "avatar-stand-blast-right-3";
    ...
    public static final String LOOKBACK_RIGHT = "avatar-stand-lookback-right";
    public static final String LOOKBACK_LEFT = "avatar-stand-lookback-left";
    public static final String RECOILING_RIGHT = "avatar-recoil-right";
    ...
    public static final String LOOKUP_FALL_RIGHT = "avatar-lookup-fall-right";
    public static final String LOOKUP_FALL_LEFT = "avatar-lookup-fall-left";
    public static final String LOOKDOWN_FALL_RIGHT = "avatar-lookdown-fall-right";
    public static final String LOOKDOWN_FALL_LEFT = "avatar-lookdown-fall-left";
    public static final String LOOKUP_HOVER_RIGHT_1 = "avatar-lookup-hover-right-1";
    public static final String LOOKUP_HOVER_LEFT_1 = "avatar-lookup-hover-left-1";
    public static final String LOOKDOWN_HOVER_RIGHT_1 = "avatar-lookdown-hover-right-1";
    public static final String LOOKDOWN_HOVER_LEFT_1 = "avatar-lookdown-hover-left-1";
    public static final String LOOKUP_HOVER_RIGHT_2 = "avatar-lookup-hover-right-2";
    public static final String LOOKUP_HOVER_LEFT_2 = "avatar-lookup-hover-left-2";
    public static final String LOOKDOWN_HOVER_RIGHT_2 = "avatar-lookdown-hover-right-2";
    public static final String LOOKDOWN_HOVER_LEFT_2 = "avatar-lookdown-hover-left-2";
    public static final String GRASP_RIGHT = "avatar-grasp-right";
    public static final String GRASP_LEFT = "avatar-grasp-left";
    ...
    public static final String STRIDE_LEFT_1 = "avatar-stride-1-left";
    public static final String STRIDE_RIGHT_2 = "avatar-stride-2-right";
    public static final String STRIDE_LEFT_2 = "avatar-stride-2-left";
    ...
    public static final String FLIPSWIPE_RIGHT_4 = "avatar-swipe-flip-4-right";
    public static final String FLIPSWIPE_RIGHT_5 = "avatar-swipe-flip-5-right";
    public static final String FLIPSWIPE_LEFT_1 = "avatar-swipe-flip-1-left";
    public static final String FLIPSWIPE_LEFT_2 = "avatar-swipe-flip-2-left";
    public static final String FLIPSWIPE_LEFT_3 = "avatar-swipe-flip-3-left";
    public static final String FLIPSWIPE_LEFT_4 = "avatar-swipe-flip-4-left";
    public static final String FLIPSWIPE_LEFT_5 = "avatar-swipe-flip-5-left";
    public static final float FLIPSWIPE_FRAME_DURATION = .08f;
    public static final String SIDESWIPE_RIGHT_1 = "avatar-swipe-side-1-right";
    public static final String SIDESWIPE_RIGHT_2 = "avatar-swipe-side-2-right";
    public static final String SIDESWIPE_RIGHT_3 = "avatar-swipe-side-3-right";
    public static final String SIDESWIPE_LEFT_1 = "avatar-swipe-side-1-left";
    public static final String SIDESWIPE_LEFT_2 = "avatar-swipe-side-2-left";
    public static final String SIDESWIPE_LEFT_3 = "avatar-swipe-side-3-left";
