...
public final class Constants {
    ...
    public static final String LOOKUP_STAND_RIGHT = "lookup-stand-right";
    public static final String LOOKUP_STAND_LEFT = "lookup-stand-left";
    public static final String LOOKDOWN_STAND_RIGHT = "lookdown-stand-right";
    public static final String LOOKDOWN_STAND_LEFT = "lookdown-stand-left";
    public static final String LOOKUP_FALL_RIGHT = "lookup-fall-right";
    public static final String LOOKUP_FALL_LEFT = "lookup-fall-left";
    public static final String LOOKDOWN_FALL_RIGHT = "lookdown-fall-right";
    public static final String LOOKDOWN_FALL_LEFT = "lookdown-fall-left";
    public static final String LOOKUP_HOVER_RIGHT_1 = "lookup-hover-right-1";
    public static final String LOOKUP_HOVER_LEFT_1 = "lookup-hover-left-1";
    public static final String LOOKDOWN_HOVER_RIGHT_1 = "lookdown-hover-right-1";
    public static final String LOOKDOWN_HOVER_LEFT_1 = "lookdown-hover-left-1";
    public static final String LOOKUP_HOVER_RIGHT_2 = "lookup-hover-right-2";
    public static final String LOOKUP_HOVER_LEFT_2 = "lookup-hover-left-2";
    public static final String LOOKDOWN_HOVER_RIGHT_2 = "lookdown-hover-right-2";
    public static final String LOOKDOWN_HOVER_LEFT_2 = "lookdown-hover-left-2";
