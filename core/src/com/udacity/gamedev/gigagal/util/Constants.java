...
public final class Constants {
    ...
    public static final String[] LEVELS = {"levels/RUBBER.dt", "levels/ELECTRIC.dt", "levels/WATER.dt", "levels/FIRE.dt", "levels/METAL.dt", "levels/PSYCHIC.dt", "levels/FINAL.dt"};
