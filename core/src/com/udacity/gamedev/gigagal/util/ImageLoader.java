...
// immutable singleton
public final class ImageLoader implements AssetErrorListener {
    ...
    // static factory
    public static final ImageLoader getInstance() { return INSTANCE; }

    public final void create() {
        AssetManager assetManager = new AssetManager();
        assetManager.setErrorListener(this);
        assetManager.load(Constants.TEXTURE_ATLAS, TextureAtlas.class);
        assetManager.load(Constants.AUDIO_DIRECTORY + "powerup.wav", Sound.class);
...
//        fontAssets = new fontAssets(fonts);
    ...
    public static final class SoundAssets {

        public final Sound powerup;

        private SoundAssets(Array<Sound> sounds) {
            powerup = sounds.get(sounds.indexOf(Gdx.audio.newSound(Gdx.files.internal(Constants.AUDIO_DIRECTORY + "powerup.wav")), true));
        }
    }

    public static final class MusicAssets {}
