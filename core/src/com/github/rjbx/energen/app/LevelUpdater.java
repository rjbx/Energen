...
class LevelUpdater {
    ...
    public boolean updateGround(float delta, Ground ground) {
        ...
        Rectangle updateBounds = new Rectangle(chaseCam.getCamera().position.x - chaseCam.getViewport().getWorldWidth() / 3, chaseCam.getCamera().position.y - chaseCam.getViewport().getWorldHeight() / 3, chaseCam.getViewport().getWorldWidth() / 1.5f, chaseCam.getViewport().getWorldHeight() / 1.5f);
