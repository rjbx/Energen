...
public final class Constants {
    ...
    public static final AssetDescriptor<Sound> BLAST_NATIVE_SOUND = new AssetDescriptor<Sound>("audio/nativeBlast.mp3", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_PLASMA_SOUND = new AssetDescriptor<Sound>("audio/plasmaBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_GAS_SOUND = new AssetDescriptor<Sound>("audio/gasBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_LIQUID_SOUND = new AssetDescriptor<Sound>("audio/liquidBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_ORE_SOUND = new AssetDescriptor<Sound>("audio/oreBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_SOLID_SOUND = new AssetDescriptor<Sound>("audio/solidBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_ANTIMATTER_SOUND = new AssetDescriptor<Sound>("audio/antimatterBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> BLAST_HYBRID_SOUND = new AssetDescriptor<Sound>("audio/hybridBlast.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_NATIVE_SOUND = new AssetDescriptor<Sound>("audio/shot-native.mp3", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_PLASMA_SOUND = new AssetDescriptor<Sound>("audio/shot-plasmaShot.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_GAS_SOUND = new AssetDescriptor<Sound>("audio/shot-gasShot.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_LIQUID_SOUND = new AssetDescriptor<Sound>("audio/shot-liquidShot.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_ORE_SOUND = new AssetDescriptor<Sound>("audio/shot-oreShot.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_SOLID_SOUND = new AssetDescriptor<Sound>("audio/shot-solidShot.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_ANTIMATTER_SOUND = new AssetDescriptor<Sound>("audio/shot-antimatterShot.wav", Sound.class);
    public static final AssetDescriptor<Sound> SHOT_HYBRID_SOUND = new AssetDescriptor<Sound>("audio/shot-hybridShot.wav", Sound.class);
    ...
    public static final String LAUNCH_MESSAGE = "Energen v0.0.4";
